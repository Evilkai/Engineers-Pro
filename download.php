...
<button class="navbar-toggler navbar-toggler-right custom-toggler" type="button" data-toggle="collapse" data-target="#collapsingNavbar4">
	 ...
	 <div class="navbar-collapse collapse text-center justify-content-end" id="collapsingNavbar4">
       <div class="dropdown-divider"></div>
         <a class="btn navbar-btn ml-md-2 btn-light text-white1" href="signin.php" >Sign-in</a>
		...
		<ul class="navbar-nav">
          ...
          <li class="nav-item mx-2"><a class="nav-link text-white3" href="contact.php">Contact Us</a></li>
		</ul>
      </div>
    </div>
  </nav>
        ...
        <div class="col-lg-4 px-4 px-md-0">
          <div class="row mb-4">
            ...
            <div class="col-6">
              ...
              <a class="btn navbar-btn ml-md-2 btn-light text-white1" href="1st_sem.php">Select</a>
            </div>
          </div>
          <div class="row mb-4">
            ...
            <div class="col-6">
              ...
              <a class="btn navbar-btn ml-md-2 btn-light text-white1" href="2nd_sem.php">Select</a>
            </div>
          </div>
          <div class="row mb-4">
            ...
            <div class="col-6">
              ...
              <a class="btn navbar-btn ml-md-2 btn-light text-white1" href="3rd_sem.php">Select</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 px-4 px-md-0">
          <div class="row mb-4">
            ...
            <div class="col-6">
              ...
              <a class="btn navbar-btn ml-md-2 btn-light text-white1" href="4th_sem.php">Select</a>
            </div>
          </div>
          <div class="row mb-4">
            ...
            <div class="col-6">
              ...
              <a class="btn navbar-btn ml-md-2 btn-light text-white1" href="5th_sem.php">Select</a>
            </div>
          </div>
          <div class="row mb-4">
            ...
            <div class="col-6">
              ...
              <a class="btn navbar-btn ml-md-2 btn-light text-white1" href="6th_sem.php">Select</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 px-4 px-md-0">
          <div class="row mb-4">
            ...
            <div class="col-6">
              ...
              <a class="btn navbar-btn ml-md-2 btn-light text-white1" href="7th_sem.php">Select</a>
            </div>
          </div>
          <div class="row mb-4">
            ...
            <div class="col-6">
              ...
              <a class="btn navbar-btn ml-md-2 btn-light text-white1" href="8th_sem.php">Select</a>
            </div>
          </div>
